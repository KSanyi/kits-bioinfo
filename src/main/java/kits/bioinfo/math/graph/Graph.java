...
public class Graph<T> {
	...
	public void addNode(T node){
		if(adjacencyMap.containsKey(node)) throw new IllegalArgumentException("Node is already in graph");
	...
	public List<T> adjacentNodes(T node) {
		return new LinkedList<>(adjacencyMap.getOrDefault(node, Collections.emptyList()).stream()
